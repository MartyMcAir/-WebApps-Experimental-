...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-4">Simple Examples & code trash (AJAX)</h1>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light rounded">
        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample10">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Ajax Main Page</a>
                </li>
                <li class="nav-item">
    ...
    <div class="card-deck mb-3 text-center">
        <div class="card mb-4 shadow-sm">
            <div class="card-header">
                <h4 class="my-0 font-weight-normal">AJAX Simple Methods _ ..</h4>
            </div>
            <div class="card-body">
        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                <ul class="list-unstyled mt-3 mb-4">
                    ...
                    <li><a class="text-muted" href="./hello-LibraryServletSQL">LibraryServletSQL маппинга</a></li>
                </ul>
            </div>
        </div>
