...
<%--<img src="${contextPath}/public_resources/martyPNG.png" alt="here image"/>--%>
...
<footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row">
        <div class="col-12 col-md">
            ...
            <%--            <img class="mb-2" src="${contextPath}/img/martyPNG.png" alt="" width="24" height="24">--%>
            <%--            <img class="mb-2" src="${contextPath}/img/martyMcAirHeadOnly_24.svg" alt="" width="36" height="36">--%>
...
<script src="${contextPath}/public_resources/js/jquery-3.5.0.js"></script>
...
<%--    <script src="${contextPath}/public_resources/js/myJs.js"></script>--%>