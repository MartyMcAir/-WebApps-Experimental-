...
<div class="container">
    ...
    <ul class="list-unstyled mt-3 mb-4">
        <li><a class="text-muted" href="${contextPath}/ajaxPages/ajaxPost.jsp">current page is: ajaxGet.jsp</a></li>
    </ul>
    ...
    <strong>My Experimental table withOut JSON _ get by plain/text</strong>
...
<script src="${contextPath}/public_resources/js/examples/ajaxPostJsonRequest.js"></script>
<script src="${contextPath}/public_resources/js/examples/ajaxFetchPost.js"></script>
