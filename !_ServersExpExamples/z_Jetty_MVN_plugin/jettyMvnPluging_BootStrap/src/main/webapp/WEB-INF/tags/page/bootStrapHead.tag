...
<%--    <link rel="stylesheet" href="./static/bootstrap4_5/css_examples/pricing.css">--%>
...
<link rel="shortcut icon" href="./static/img/martyMcAirHeadOnly_24.svg">
...
<%--<link rel="shortcut icon" href="./img/martyMcAir_Icon_36.ico" type="image/x-icon">--%>
<%--<link rel="shortcut icon" href="./img/martyPNG.png" type="image/png">--%>
