...
@RestController
@RequestMapping("/crud")
public class z_CRUDController {

    // here need use cUrl tool for Json Request
    @GetMapping
    ...
    public HttpHeaders save(@RequestBody @Valid CrudInput crudInput) {
        ...
        httpHeaders.setLocation(linkTo(z_CRUDController.class).slash(crudInput.getId()).toUri());
        return httpHeaders;
    }
