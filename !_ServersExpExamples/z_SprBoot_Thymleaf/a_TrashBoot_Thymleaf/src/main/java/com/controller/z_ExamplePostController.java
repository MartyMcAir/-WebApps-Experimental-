...
import com.services.ExampleService;
import com.utils.ResponseTransfer;
...
@Controller
@RequestMapping("/post")
public class z_ExamplePostController {

    private static Logger log = LoggerFactory.getLogger(z_ExamplePostController.class);
