...
<%--    <link rel="stylesheet" href="${contextPath}/public_resources/bootstrap4_5/css_examples/pricing.css">--%>
<link rel="stylesheet" href="${contextPath}/public_resources/bootstrap4_5/css_examples/blog.css">
<%--<link rel="stylesheet" href="${contextPath}/public_resources/css/myCss2.css">--%>

<%-- --%>
<%--    --%>

<link rel="shortcut icon" href="${contextPath}/public_resources/img/martyMcAirHeadOnly_24.svg">
...
<%--<link rel="shortcut icon" href="${contextPath}/img/martyMcAir_Icon_36.ico" type="image/x-icon">--%>
<%--<link rel="shortcut icon" href="${contextPath}/img/martyPNG.png" type="image/png">--%>
