...
<%--<img src="${contextPath}/resources/martyPNG.png" alt="here image"/>--%>
<%--<img src="C:\Users\marty\OneDrive\Dropbox\GitHub\-WebApps-Experimental-\WebAppByServlets\web\public_resources\img\martyMcAirColor.svg"--%>
<%--     alt="here image"/>--%>
...
<footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row">
        <div class="col-12 col-md">
            ...
            <%--            <img class="mb-2" src="${contextPath}/resources/img/martyPNG.png" alt="" width="24" height="24">--%>
            <%--            <img class="mb-2" src="${contextPath}/resources/img/martyMcAirHeadOnly_24.svg" alt="" width="36" height="36">--%>
...
<script src="${contextPath}/resources/js/jquery-3.5.0.js"></script>
<%-- bootstrap required jQuery and jQuery most bee included first --%>
<script src="${contextPath}/resources/bootstrap4_5/js/bootstrap.min.js"></script>
