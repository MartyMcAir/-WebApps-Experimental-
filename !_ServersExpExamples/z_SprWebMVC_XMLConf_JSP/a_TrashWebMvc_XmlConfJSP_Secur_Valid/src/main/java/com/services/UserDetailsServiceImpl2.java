...
//    private EntityManager em;
    ...
    // Unsatisfied dependency expressed through field 'bCryptPasswordEncoder'
//    @Autowired
//    BCryptPasswordEncoder bCryptPasswordEncoder;
    ...
    public UserDetails loadUserByUsername_orig(String username) throws UsernameNotFoundException {
        User s = new User();
        s.setUsername("root");
        // 1234
