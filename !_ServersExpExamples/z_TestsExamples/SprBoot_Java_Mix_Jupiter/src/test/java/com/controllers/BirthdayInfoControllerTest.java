...
import com.services.BasicBirthdayService;
...
// Integration Tests
// https://developer.okta.com/blog/2019/03/28/test-java-spring-boot-junit5#integration-tests-with-junit-5
...
class BirthdayInfoControllerTest {
    ...
    private void testDOW(String birthday, String dow) throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/birthday/dayOfWeek")
                .with(user(TEST_USER_ID)) // user token here
                .with(csrf()) // user token here
                .content(birthday)
